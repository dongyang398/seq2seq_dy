...
from seq2seq.BasicSeq2seqModel import BasicSeq2SeqModel
...
def train():
    ...
    '''
      encoder是否双向
                注意:使用bidirectional，encoder rnn的num_units变为decoder的一半，这是为了能够保证
    ...
    #训练
    model = BasicSeq2SeqModel(src_vocab_size=dataInfoObj.source_vocab_size,
    ...
    model.train("../modelFile/testBasicSeq2Seq/model_beam_search.ckpt",
                gen,
                src_embedding_size,
                tgt_embedding_size,
